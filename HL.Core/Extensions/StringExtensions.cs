...
namespace Hl.Extensions
{
    public static class StringExtensions
    {
        ...
        public static DateTime ToDateTimeByStamp(this string value)
        {
            DateTime startTime = TimeZone.CurrentTimeZone.ToLocalTime(new DateTime(1970, 1, 1));
            long lTime = long.Parse(value + "0000000");
            var toNowTime = new TimeSpan(lTime);
            return DateTime.Parse(startTime.Add(toNowTime).ToString("yyyy-MM-dd HH:mm:ss"));
        }
